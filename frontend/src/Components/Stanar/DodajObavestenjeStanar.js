...
export default function DodajObavestenjeStanar() {
    ...
    const saveData=async()=> {
        try {
            const response = await axiosPrivate.post(`http://localhost:8080/api/obavestenje/dodajObavestenjeStanar/`+user.stanarId, formValues);
        ...
        <div className="Dodaj" style={{
            ...
            <form className="" onSubmit={handleSubmit} >
                ...
                <div className="forma" >
                    ...
                    <button className="dugme" onClick={() => navigate("/ObavestenjaStanar", { state: idZgrade })}>Nazad</button>
